...
import (
	...
	base "github.com/metatechchain/meta-base/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (metatechchain.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules metatechchain.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules metatechchain.Rules) error {
...
func CheckTxs(txs types.Transactions, rules metatechchain.Rules) error {
	maxType := uint8(0)
