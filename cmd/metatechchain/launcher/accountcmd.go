...
var (
	walletCommand = cli.Command{
		...
		Description: `
    metatechchain wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	metatechchain wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    metatechchain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    metatechchain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    metatechchain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    metatechchain account import [options] <keyfile>
