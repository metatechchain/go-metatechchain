...
import (
	...
	"github.com/metatechchain/go-metatechchain/utils/iodb"
	"github.com/metatechchain/go-metatechchain/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	cfg := makeAllConfigs(ctx)
	cfg.Metatechchain.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.Metatechchain.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.Metatechchain.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.Metatechchain.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
