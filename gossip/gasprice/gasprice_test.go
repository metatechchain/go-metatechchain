...
type TestBackend struct {
	...
	rules             metatechchain.Rules
	pendingRules      metatechchain.Rules
}
...
func (t TestBackend) GetRules() metatechchain.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() metatechchain.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             metatechchain.FakeNetRules(),
		pendingRules:      metatechchain.FakeNetRules(),
	}
