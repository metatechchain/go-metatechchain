...
func DefaultConfig() Config {
	return Config{
		...
		LimitedTpsThreshold: metatechchain.DefaultEventGas * 120,
		NoTxsThreshold:      metatechchain.DefaultEventGas * 30,
		EmergencyThreshold:  metatechchain.DefaultEventGas * 5,
