...
func (s *Store) ApplyGenesis(blockProc BlockProc, g metatechchain.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g metatechchain.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g metatechchain.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g metatechchain.Genesis) hash.Event {
