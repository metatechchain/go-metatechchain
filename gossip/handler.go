...
import (
	...
	"github.com/metatechchain/meta-base/gossip/dagprocessor"
	"github.com/metatechchain/meta-base/gossip/dagstream"
	"github.com/metatechchain/meta-base/gossip/dagstream/streamleecher"
	"github.com/metatechchain/meta-base/gossip/dagstream/streamseeder"
	"github.com/metatechchain/meta-base/gossip/itemsfetcher"
	...
	"github.com/metatechchain/go-metatechchain/eventcheck/parentlesscheck"
...
// newHandler returns a new MetaTech sub protocol manager. The MetaTech sub protocol manages peers capable
// with the MetaTech network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping MetaTech Chain protocol")
	...
	log.Info("MetaTech Chain protocol stopped")
}
