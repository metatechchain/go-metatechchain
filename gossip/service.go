...
import (
	...
	"github.com/metatechchain/go-metatechchain/ethapi"
	"github.com/metatechchain/go-metatechchain/eventcheck"
	...
	"github.com/metatechchain/go-metatechchain/gossip/blockproc"
	"github.com/metatechchain/go-metatechchain/gossip/blockproc/drivermodule"
	"github.com/metatechchain/go-metatechchain/gossip/blockproc/eventmodule"
	"github.com/metatechchain/go-metatechchain/gossip/blockproc/evmmodule"
	"github.com/metatechchain/go-metatechchain/gossip/blockproc/sealmodule"
	"github.com/metatechchain/go-metatechchain/gossip/blockproc/verwatcher"
	"github.com/metatechchain/go-metatechchain/gossip/emitter"
	"github.com/metatechchain/go-metatechchain/gossip/filters"
	...
	"github.com/metatechchain/go-metatechchain/utils/gsignercache"
	"github.com/metatechchain/go-metatechchain/utils/wgmutex"
	"github.com/metatechchain/go-metatechchain/valkeystore"
...
func DefaultBlockProc(g metatechchain.Genesis) BlockProc {
	return BlockProc{
...
func NewService(stack *node.Node, config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine meta.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
...
func newService(config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine meta.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
	svc := &Service{
		config:             config,
...
// MakeProtocols constructs the P2P protocol definitions for `metatechchain`.
...
func (s *Service) Stop() error {
	defer log.Info("MetaTech Chain service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
