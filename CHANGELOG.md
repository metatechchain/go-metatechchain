...
* cmd: Enable reading config from file (meta.toml, .json, or .yaml)

IMPROVEMENTS:

* node: major refactoring of configuration and initialization of Meta node.
...
instead. 
* docs: Added sections on Meta and FastSync.